 ...
 * `volatile`. DSH 0.1.7-alpha.1 ships 3.18.3, and 0.1.7-alpha.2 / 0.1.7-rc.1 / 0.1.7-rc.2
 * ship 3.18.4; those copies use `volatile` to project plugin Config into the settings
